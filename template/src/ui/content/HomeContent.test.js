...
vi.mock("@next2d/framework", () => ({
    MovieClipContent: vi.fn().mockImplementation(function() {
...
describe("HomeContent", () => {
    ...
    /**
     * @description Draggable インターフェースのテスト
     *              Test for Draggable interface
     */
    describe("Draggable Interface / Draggable インターフェース", () => {
