...
export class HomePage extends Sprite {
    ...
    initialize (vm) {
         ...
         */
        homeContent.addEventListener(PointerEvent.POINTER_DOWN, (event) => {
            vm.homeContentPointerDownEvent(event);
        });
        homeContent.addEventListener(PointerEvent.POINTER_UP, (event) => {
         ...
         */
        textField.addEventListener(Event.CHANGE, (event) => {
